...
export default {
  inputColorContainer: cva('flex w-full items-center dark:text-zinc-300', {
    variants: {
      intent: {
        primary: '',
        custom: ''
  ...
  colorContainer: cva(
    [
      ...
      'border border-gray-300 dark:border-zinc-700 flex rounded overflow-hidden shrink-0'
    ],
    {
      variants: {
        size: {
  ...
  divider: cva('bg-gray-300 dark:bg-zinc-700 w-px self-stretch shrink-0'),
